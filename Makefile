...
test.mixer-adapter:
	go test `go list ./components/global/mixer-adapter/pkg/... | grep -v ./components/global/mixer-adapter/pkg/signals` -race -covermode=atomic -coverprofile=./components/global/mixer-adapter/target/coverage.txt ./components/global/mixer-adapter/pkg/$(TARGET)/...
