...
class BaseTestCase {
    ...
    protected static final String DEFAULT_NAMESPACE = "test-default";
    ...
    /**
     * Generate a K8s Cell object in the default namespace.
    ...
    Cell generateCell(String cellName, Gateway gateway, List<Component> components) {
        return generateCell(DEFAULT_NAMESPACE, cellName, gateway, components);
    }
     ...
     * @return The generated Cell
     */
    Cell generateCell(String namespace, String cellName, Gateway gateway, List<Component> components) {
    ...
    /**
     * Generate a K8s Composite object in default namespace.
    ...
    Composite generateComposite(String compositeName, List<Component> components) {
        return generateComposite(DEFAULT_NAMESPACE, compositeName, components);
    }
     ...
     * @return The generated Composite
     */
    Composite generateComposite(String namespace, String compositeName, List<Component> components) {
     ...
     */
    Gateway generateGatewayTemplate(String host, List<HTTP> httpIngresses, List<TCP> tcpIngresses,
                                    List<GRPC> grpcIngresses) {
    ...
    /**
     * Generate a K8s Service Template Object in default namespace.
     *
    ...
    Component generateServicesTemplate(String serviceName, String protocol) {
        return generateServicesTemplate(DEFAULT_NAMESPACE, serviceName, protocol);
    }
     ...
     * @return The generated Service Template
     */
    Component generateServicesTemplate(String namespace, String serviceName, String protocol) {
        Port port = new Port();
    ...
    /**
     * Generate a Cellery Cell Component K8s pod object in default namespace.
    ...
    Pod generateCelleryCellComponentPod(String cell, String component) {
        return generateCelleryCellComponentPod(DEFAULT_NAMESPACE, cell, component);
    }
     ...
     * @return The generated pod
     */
    Pod generateCelleryCellComponentPod(String namespace, String cell, String component) {
        ...
        PodStatus podStatus = new PodStatusBuilder()
                .withPhase("Running")
                .build();
        return generatePod(namespace, podName, labels, podStatus);
    }

    /**
     * Generate a Cellery Cell Gateway K8s pod object in default namespace.
     * The returned pod can be used as one of the returned pods in K8s Mock Server in expectation mode.
     *
     * @param cell      The Cell the Pod belongs to
     * @return The generated pod
    ...
    Pod generateCelleryCellGatewayPod(String cell) {
        return generateCelleryCellGatewayPod(DEFAULT_NAMESPACE, cell);
    }
     ...
     * @return The generated pod
     */
    Pod generateCelleryCellGatewayPod(String namespace, String cell) {
    ...
    /**
     * Generate a Cellery Composite Component K8s pod object in default namespace.
     * The returned pod can be used as one of the returned pods in K8s Mock Server in expectation mode.
     *
    ...
    Pod generateCelleryCompositeComponentPod(String composite, String component) {
        return generateCelleryCompositeComponentPod(DEFAULT_NAMESPACE, composite, component);
    }
     ...
     * @return The generated pod
     */
    Pod generateCelleryCompositeComponentPod(String namespace, String composite, String component) {
    ...
    /**
     * Generate a Cellery Cell Component K8s pod object with a failing state in default namespace.
     * The returned pod can be used as one of the returned pods in K8s Mock Server in expectation mode.
     *
     * @param cell      The Cell the Pod belongs to
     * @param component The component of the Cell the pod belongs to
    ...
    Pod generateFailingCelleryCellComponentPod(String cell, String component) {
        return generateFailingCelleryCellComponentPod(DEFAULT_NAMESPACE, cell, component);
    }
     ...
     * @return The generated pod
     */
    Pod generateFailingCelleryCellComponentPod(String namespace, String cell, String component) {
        String podName = cell + "--" + component;
    ...
    /**
     * Generate a Cellery Cell Gateway K8s pod object with a failing state in default namespace.
     * The returned pod can be used as one of the returned pods in K8s Mock Server in expectation mode.
     *
     * @param cell      The Cell the Pod belongs to
     * @return The generated pod
    ...
    Pod generateFailingCelleryCellGatewayPod(String cell) {
        return generateFailingCelleryCellGatewayPod(DEFAULT_NAMESPACE, cell);
    }
     ...
     * @return The generated pod
     */
    Pod generateFailingCelleryCellGatewayPod(String namespace, String cell) {
        String podName = cell + "--gateway";
    ...
    /**
     * Generate a Cellery Composite Component K8s pod object with a failing state in default namespace.
     * The returned pod can be used as one of the returned pods in K8s Mock Server in expectation mode.
     *
     * @param composite The Composite the Pod belongs to
     * @param component The component of the Composite the pod belongs to
    ...
    Pod generateFailingCelleryCompositeComponentPod(String composite, String component) {
        return generateFailingCelleryCompositeComponentPod(DEFAULT_NAMESPACE, composite, component);
    }
     ...
     * @return The generated pod
     */
    Pod generateFailingCelleryCompositeComponentPod(String namespace, String composite, String component) {
        String podName = composite + "--" + component;
     ...
     * @return The generated pod
     */
    private Pod generatePod(String namespace, String podName, Map<String, String> labels, PodStatus status) {
