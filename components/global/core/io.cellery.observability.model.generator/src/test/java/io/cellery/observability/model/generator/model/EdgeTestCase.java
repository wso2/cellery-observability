...
public class EdgeTestCase {
    ...
    public void testEquality() {
        Edge edgeA = new Edge(
                ...
                new EdgeNode("destination-namespace", "destination-instance", "destination-component")
        );
        Edge edgeB = new Edge(
                new EdgeNode("source-namespace", "source-instance", "source-component"),
                new EdgeNode("destination-namespace", "destination-instance", "destination-component")
    ...
    public void testInEqualityWithMismatchedDestinationNamespace() {
        ...
        Edge edgeB = new Edge(
                new EdgeNode("source-namespace", "source-instance", "source-component"),
                new EdgeNode("different-namespace", "destination-instance", "destination-component")
        );
        Assert.assertNotEquals(edgeA, edgeB);
    }
    ...
    public void testInEqualityWithMismatchedDestinationInstance() {
        ...
        Edge edgeB = new Edge(
                new EdgeNode("source-namespace", "source-instance", "source-component"),
                new EdgeNode("destination-namespace", "different-instance", "destination-component")
        );
        Assert.assertNotEquals(edgeA, edgeB);
    }
    ...
    public void testInEqualityWithMismatchedDestinationComponent() {
        ...
        Edge edgeB = new Edge(
                new EdgeNode("source-namespace", "source-instance", "source-component"),
                new EdgeNode("destination-namespace", "destination-instance", "different-component")
        );
        Assert.assertNotEquals(edgeA, edgeB);
    }
}
